...
## 📊 解題統計
- **總題數：** $TOTAL 題
- **難度分布：** Easy $EASY_DIRS 題, Medium $MEDIUM_DIRS 題$(if [ $HARD_DIRS -gt 0 ]; then echo ", Hard $HARD_DIRS 題"; fi)
- **更新日期：** $(date +%Y-%m-%d)
...
| 133 | [clone graph](https://leetcode.com/problems/clone-graph/) | [solution.py](medium/0133-clone-graph/solution.py) | [筆記](medium/0133-clone-graph/README.md) |
...
| 200 | [number of islands](https://leetcode.com/problems/number-of-islands/) | [solution.py](medium/0200-number-of-islands/solution.py) | [筆記](medium/0200-number-of-islands/README.md) |
